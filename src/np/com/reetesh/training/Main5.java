...
public class Main5 extends BaseGameActivity {
	...
	public void onLoadResources() {
		...
		final BitmapTextureAtlas bgTexture= new BitmapTextureAtlas(
		...
		bgRegion= BitmapTextureAtlasTextureRegionFactory.createFromAsset(
				bgTexture, getApplicationContext(), "blue_bg.png", 0, 0);
		
		final BitmapTextureAtlas pandaTexture= new BitmapTextureAtlas(
				128, 64, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		pandaRegion= BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(
				pandaTexture, getApplicationContext(), "panda_anim.png", 0, 0, 2, 1);
	...
	public Scene onLoadScene() {
		...
		final AnimatedSprite panda= new AnimatedSprite(100, 100, pandaRegion);
